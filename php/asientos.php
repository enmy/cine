...
<body background="../img/wallpaper.jpg">
            ...
            <div class="col-md-3" style="height:100%;">
                <?php
                    ...
                    if(!isset($_SESSION["autentificado"]) || !$_SESSION["autentificado"])
                        echo '<a href="sesion/inicio-sesion.php" style="float:right; color:white;">Iniciar sesi&oacute;n</a>';
                    else
                    {   
                        echo '<span style="color:white;">'.$_SESSION["nombre_usuario"].'</span><a href="sesion/salir.php" style="float:right; color:white;">Cerrar sesi&oacute;n</a>';
                    }
                ?>
            </div>
        </div>
    ...
    <script src="/cine/js/jquery-1.10.2.js"></script>
    <script src="/cine/js/bootstrap.js"></script>
